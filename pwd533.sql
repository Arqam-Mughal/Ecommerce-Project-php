...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 15, 2024 at 01:13 AM
...
(1, 'Ahmad', 'Ali', 'superadmin@gmail.com', '21232f297a57a5a743894a0e4a801fc3', '21232f297a57a5a743894a0e4a801fc3', '', '', 1);
...
--
-- Dumping data for table `pos-cart`
--

INSERT INTO `pos-cart` (`posid`, `code`, `name`, `price`, `qty`, `stock`, `total`, `email`) VALUES
(336, '20', 'Angarkha', '6999', '2', '2', '13998', 'superadmin@gmail.com'),
(337, '30', 'Sherwani', '11999', '2', '3', '23998', 'superadmin@gmail.com');
...
--
ALTER TABLE `pos-cart`
  MODIFY `posid` bigint(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=338;
