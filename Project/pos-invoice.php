          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a class="nav-link" href="invoice.html">Invoice</a></li>
              </ul>
            </li>
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i
                ...
                <div class="row">
                  <div class="col-lg-12">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <?php 
                        $sslq = "SELECT * FROM `pos-userinfo` WHERE `pos-uinvoice`='$onum'";
                        $srsn = mysqli_query($connection,$sslq);
                        while($fgett = mysqli_fetch_assoc($srsn)){
                          ?>
                           <address>
                          <strong>Billed To:</strong><br>
                          <?php echo $fgett['pos-uname']; ?><br>
                          <?php echo $fgett['pos-uphone']; ?>,<br>
                          <?php echo $fgett['pos-email']; ?><br>
                          <?php echo $fgett['pos-date']; ?>
                        </address>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <address>
                          ...
                          <?php echo $fgett['pos-ustatus']; ?><br>
                          <?php echo $fgett['pos-email']; ?>
                        </address>
                      </div>
                      <div class="col-md-6 text-md-right">
                        <address>
                          <strong>Order Date:</strong><br>
                          <?php echo $fgett['pos-date']; ?><br><br>
                        </address>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped table-hover table-md">
                        ...
                        <?php 
                        $slq = "SELECT * FROM `pos-orderinfo` WHERE `pos-pinvoice`='$onum'";
                        $srn = mysqli_query($connection,$slq);
                        $gtotal=0;
                        while($fget = mysqli_fetch_assoc($srn)){
                          $gtotal=$gtotal+$fget['pos-pprice'];
                          ?>
                          <tr>
                          <td><?php echo $fget['pos-ppid']; ?></td>
                          <td><?php echo $fget['pos-pname']; ?></td>
                          <td class="text-center"><?php echo $fget['pos-sprice']; ?></td>
                          <td class="text-center"><?php echo $fget['pos-pqty']; ?></td>
                          <td class="text-right"><?php echo $fget['pos-pprice']; ?></td>
                        </tr>
                        <?php
                        }
                        ?>
