					...
					<div class="row">
						<div class="col-lg-3">
							<div class="all-category">
								...
								$run = mysqli_query($connection,$psql);

								 while($cfet = mysqli_fetch_assoc($run)){

                                ?>
									<li><a href="./categary.php?pid=<?php echo $cfet['pid']; ?>"><?php echo $cfet['pname']; ?><i class="fa fa-angle-right"
												aria-hidden="true"></i></a>
										<ul class="sub-category">
											<?php
											$pid = $cfet['pid'];
											$csql = "SELECT * FROM `subcategary` WHERE `spid`='$pid'";
											
											$srun = mysqli_query($connection,$csql);
									...
									<div class="navbar-collapse">
										<div class="nav-inner">
											<ul class="nav main-menu menu navbar-nav">
												...
												<li><a href="./blog-single-sidebar.php">Blog</a>
												</li>
