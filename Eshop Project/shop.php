			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-9 col-md-8 col-12">
						...
						<?php
						$psql = "SELECT * FROM `product` WHERE `status`='online'";
								...
								<div class="single-product">
									<div class="product-img">
										<a href="product-details.html">
											<img style="height:300px;" class="default-img" src="<?php echo "../Project/img/".$pic[0] ?>" alt="Img not found">
